...
export const traffic_and_delays = [
  {
    message_id: "MSG_1",
...
export const issues_at_restaurant = [
  {
    message_id: "MSG_11",
...
export const passenger_location = [
  {
    message_id: "MSG_15",
